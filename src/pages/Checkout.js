...
function Checkout() {
    ...
    const handleOrder = (e) => {
        if(selectedAddress && paymentMethod) {
            ...
            // TODO: we can use proper messaging poppu here
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    <div className="lg:col-span-3">
                        <form className='bg-white px-5 mt-12 py-5' noValidate onSubmit={handleSubmit((data) => {
                                ...
                                <div className="border-b border-gray-900/10 pb-12">
                                    ...
                                    <ul role="list">
                                        {user.addresses.map((address, index) => (
                                            <li key={index} className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-gray-200 my-5">
                                                <div className="flex min-w-0 gap-x-4">
                                                    <input onChange={e => handleAddress(e)} value={index} name="address" type="radio" className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" />
