    ...
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t  border-gray-200 px-4 py-6 sm:px-6">
          <h1 className="text-4xl my-10 font-bold tracking-tight text-gray-900">Name: {user.name ? user.name : 'New User'} </h1>
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          {showAddAddressForm ?
                <form className='bg-white px-5 mt-12 py-5' noValidate
                ...
                >
                  <div className="space-y-12">
                      ...
                      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <div className="mt-2">
                            <input
                              type="text"
                              {...register('pinCode', { required: 'ZIP is required!!' })}
                              id="pinCode"
                              className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            />
                          </div>
                    ...
                    <button
                        ...
                        className="rounded-md bg-white-600 px-3 py-2 text-sm font-semibold text-indigo shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Cancel
                      </button>
                      <button
          ...
          {user.addresses.map((address, index) =>
            <div>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        ...
                        className="rounded-md  px-3 py-2 text-sm font-semibold text-indigo shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Cancel
                      </button>
                      <button
              ...
              <div className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2 border-gray-200 my-5">
