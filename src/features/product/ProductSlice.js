...
import { fetchAllProducts, fetchBrands, fetchCategories, fetchProductsByFilters, fetchProductById } from './ProductAPI';
...
export const selectAllProdcts = (state) => state.product.products;
